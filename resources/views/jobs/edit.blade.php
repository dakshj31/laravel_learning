  ...
  >
    ...
    <form method="POST" action="{{route('jobs.update', $job->id)}}" enctype="multipart/form-data">
      ...
      @method('PUT')
        ...
        <x-inputs.text id="salary" name="salary" label="Salary" type="number" placeholder="9000" :value="old('salary', $job->salary)" />
        ...
        <x-inputs.text id="contact_email" name="contact_email" label="Contact Email" placeholder="Email where you want to receive applications" :value="old('contact_email', $job->contact_email)" />
        ...
        <button
            type="submit"
            class="w-full bg-green-500 hover:bg-green-600 text-white px-4 py-2 my-3 rounded focus:outline-none">Save
        </button>
    </form>
  </div>
