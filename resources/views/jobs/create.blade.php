  ...
  <form method="POST" action="/jobs" enctype="multipart/form-data">
    @csrf
      ...
      <div class="mb-4">
          ...
          <textarea cols="30" rows="7"id="description" name="description" class="w-full px-4 py-2 border rounded focus:outline-none @error('description') border-red-500 @enderror"
