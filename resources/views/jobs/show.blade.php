        ...
        <div class="container mx-auto p-4">
            ...
            <div x-data="{ open: false }" id="applicant-form">
                ...
                <div x-cloak x-show="open" class="fixed inset-0 flex items-center justify-center bg-gray-900 bg-opacity-50">
                    <div @click.away="open = false" class="bg-white p-6 rounded-lg shadow-mdw-full max-w-md">
                        ...
                        <form method="POST" action="{{route('applicant.store', $job->id)}}" enctype="multipart/form-data">
                            ...
                            <button @click="open = false" class="bg-gray-500 hover:bg-gray-600 text-black px-4 py-2 rounded-md">Cancel</button>
                        </form>
                    </div>
                </div>
            </div>
            ...
            <p class="my-5 bg-gray-200 rounded-xl p-3">
                <i class="fas fa-info-circle mr-3"></i>You must be loggedin to apply for this job.
            </p>
            @endauth
        </div>
